                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('approval.store', $invoice->id) }}">
                                @csrf
                                <table border="1" class="table table-light" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="text-center">Sl</th>
                                            <th class="text-center">Category</th>
                                            <th class="text-center">Product Name</th>
                                            <th class="text-center" style="background-color: #65d3ff">Current Stock</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($invoice['invoice_details'] as $key => $details)
                                            <tr>
                                                ...
                                                <td class="text-center" style="background-color: #65d3ff">
